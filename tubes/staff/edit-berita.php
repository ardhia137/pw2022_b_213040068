...
$data = query("select * from berita where id = '$id'");
?>
                ...
                <input type="hidden" name="id" value="<?= $data[0]['id'] ?>">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan judul berita" name="judul" required value="<?= $data[0]['judul'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Body</label>
                      <textarea id="summernote" name="body" value=""><?= $data[0]['body'] ?></textarea>
                    </div>
                    <div class="form-group">
