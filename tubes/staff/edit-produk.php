                ...
                <input type="hidden" name="id" value="<?= $data[0]['id'] ?>">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukan Nama Produk" name="nama" required value="<?= $data[0]['nama'] ?>">
                    </div>
                    <div class="form-group">
                      <label>Kategori</label>
                      <select class="form-control" name="kategori">
                      <?php foreach ($kategori as $row) : ?>
                        <option value="<?= $row['id'] ?>" <?= (($row['id']==$data[0]['id_kategori']) ? "selected" :""); ?>><?= $row['nama'] ?></option>
                        <?php endforeach?>
                      </select>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Deskripsi</label>
                      <textarea class="form-control" rows="3" placeholder="Masukan Deskripsi Produk" name="deskripsi"><?= $data[0]['deskripsi'] ?></textarea>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Harga</label>
                      <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Masukan Harga Produk" name="harga" required value="<?= $data[0]['harga'] ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Stok</label>
                      <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Masukan Stok Produk" name="stok" required value="<?= $data[0]['stok'] ?>">
                    </div>
                    <div class="form-group">
