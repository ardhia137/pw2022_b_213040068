                    ...
                    <tbody>
                      ...
                      <?php foreach ($data as $row) : ?>
                        <tr>
                          <td><?= $i; ?></td>
                          <td><?= $row["judul"]; ?></td>
                          <td><?= (htmlspecialchars_decode(str_word_count($row['body']) > 60 ? substr($row['body'], 0, 250) . "..." : $row['body'])); ?></td>
                          <td><?= $row["penulis"]; ?></td>
                          <td><?= $row["tanggal_upload"]; ?></td>
                          <td><img src="../assets/<?= $row['gambar']; ?>" alt="" width="150"></td>
                          <td>
                            <a href="edit-berita.php?id=<?= $row["id"]; ?>" class="btn btn-success">Edit</a>
